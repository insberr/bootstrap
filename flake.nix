{
  ...
  inputs = {
    ...
    # submodules
    armillary.url = "github:StardustXR/armillary?ref=refactor/strongipc";
    atmosphere.url = "github:StardustXR/atmosphere";
    black-hole.url = "github:StardustXR/black-hole?ref=refactor/strongipc";
    comet.url = "github:StardustXR/comet?ref=refactor/strongipc";
    flatland.url = "github:StardustXR/flatland";
    gravity.url = "github:StardustXR/gravity?ref=refactor/strongipc";
    non-spatial-input.url = "github:StardustXR/non-spatial-input?ref=refactor/strongipc";
    protostar.url = "github:StardustXR/protostar?ref=refactor/strongipc";
    solar-sailer.url = "github:StardustXR/solar-sailer?ref=refactor/strongipc";
